...
export default function FeedBackCards() {
  return (
    <div style={{width:"415px", height:"315px", borderRadius:"10px 10px 10% 10%", backgroundColor:"#4F5DE4", boxShadow:"0 15px 35px rgba(0,0,0,0.2)", position:"relative", zIndex:"0"}}>
