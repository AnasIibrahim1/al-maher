...
export default function PopularCards({ href = '/courses/complete-web-dev', image = '/photo.jpg', title = 'عنوان الدورة', hours = '10', rating = 5, reviews = 24, price = 100, lessons = 24, instructor = {} }) {
  return (
    <a href={href} className="popular-cards-container" style={{width:"410px", height:"570px", borderRadius:"10px", backgroundColor:"#fff", boxShadow:"0 15px 35px rgba(0,0,0,0.2)", position:"relative", display:"flex", flexDirection:"column", alignItems:"start", justifyContent:"space-between", zIndex:"0", textDecoration:'none'}}>
