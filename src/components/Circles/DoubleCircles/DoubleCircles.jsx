...
export default function DoubleCircles() {
    return (
        <div>
            <div className="double-circles-container" style={{position: "relative", width: "450px", height: "650px", backgroundImage: "url('/photo.jpg')", backgroundSize: "cover", backgroundPosition: "center", borderRadius: "500px"}}>
            <div  style={{position: "absolute", bottom: "0", left: "-200px", width: "300px", height: "450px", backgroundImage: "url('/photo.jpg')", backgroundSize: "cover", backgroundPosition: "center", border : "10px solid #fff",  borderRadius: "500px"}}>
                <div className="abslute-1" style={{position: "relative", width: "100%", height: "100%"}}>
            ...
            <div className="absolute-2" style={{position: "absolute", top: "0", left: "-200px", width:"250px", height:"150px", backgroundColor:"#fff", borderRadius:"10px", boxShadow:"0px 4px 10px rgba(0, 0, 0, 0.1)"}}>
            ...
            <div className="absolute-3" style={{position: "absolute", top: "-40px", left: "-20px", zIndex: "-1"}}>
                <img src="/Shapes/+.svg" alt="" />
            </div>
            <div className="absolute-4" style={{position: "absolute", bottom: "-50px", left: "30px", zIndex: "1"}}>
                <img src="/Shapes/mes.svg" alt="" />
            </div>
            <div className="absolute-5" style={{position: "absolute", bottom: "40px", left: "50px", zIndex:"2"}}>
                        <IconButtons backgroundColor="#4F5DE4" borderRadius="10px" width="40px" height="40px" padding="10px" icon={<img src="/icons/msg.svg" alt=""/>} />
                    </div>
            </div>
        </div>
    )
