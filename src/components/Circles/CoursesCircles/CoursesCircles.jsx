...
export default function CoursesCircles({backgroundColor, width, height, image}) {
  return (
    <div className="courses-circles-container" style={{backgroundColor: backgroundColor, width: width, height: height, borderRadius: "50%", position: "relative", padding: "10px" }}>
      ...
      <div className="courses-circles-content" style={{backgroundColor: backgroundColor, width: "100%", height: "100%", borderRadius: "50%" }}>
        <img src={image} alt="courses-circles" style={{width: "100%", height: "100%", borderRadius: "50%" }} />
      </div>
    </div>
  )
}