  ...
  return (
    <div className="circle-with-brush-container" style={{position: position, ...style}}>
            <div className="circle-with-brush-content-inner" style={{width: "fit-content", height: "fit-content", position: "relative"}}>
                    ...
                    <div className="circle-with-brush-content-inner-circle" style={{width: "70%", height: "80%", backgroundColor: "blue", position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", borderRadius: "50%"}}>
                        <img src={src} alt="photo" style={{width: "100%", height: "100%", borderRadius: "50%"}} />
                    </div>
