...
export default function Home() {
  ...
  return (
    ...
    <GeneralBox backgroundColor="#E4E4E4" width="450px" height="100px" borderColor="#000" >
      <div style={{display: "flex", alignItems: "start", justifyContent: "start", width: "100%", height: "100%"}}>
      <h1>ده البوكس</h1>
      </div>
    </GeneralBox>
    </div>
